...
trait MPIOps extends CMacro with LibStruct with LibFunction {
  ...
  class MPIStatus
  def mpi_status_new: Rep[MPIStatus] = newStruct[MPIStatus]("MPI_Status")
  def mpi_any_src: Rep[Int] = cmacro[Int]("MPI_ANY_SOURCE")
  ...
  def mpi_send[T:Manifest](buf: Rep[Array[T]], count: Rep[Int], dataType: Rep[MPIDataType],
    dest: Rep[Int], tag: Rep[Int], comm: Rep[MPIComm]) =
    libFunction[Int]("MPI_Send", Unwrap(buf), Unwrap(count), Unwrap(dataType), Unwrap(dest), Unwrap(tag),
      Unwrap(comm))(Seq(0), Seq(), Set[Int]())

  def mpi_recv[T:Manifest](buf: Rep[Array[T]], count: Rep[Int], dataType: Rep[MPIDataType],
    src: Rep[Int], tag: Rep[Int], comm: Rep[MPIComm], status: Rep[MPIStatus]) =
    libFunction[Int]("MPI_Recv", Unwrap(buf), Unwrap(count), Unwrap(dataType), Unwrap(src), Unwrap(tag),
      Unwrap(comm), Unwrap(status))(Seq(1), Seq(0), Set[Int](6))

  def mpi_send_T[T:Manifest](buf: Rep[T], count: Rep[Int], dataType: Rep[MPIDataType],
    dest: Rep[Int], tag: Rep[Int], comm: Rep[MPIComm]) =
    libFunction[Int]("MPI_Send", Unwrap(buf), Unwrap(count), Unwrap(dataType), Unwrap(dest), Unwrap(tag),
      Unwrap(comm))(Seq(0), Seq(), Set[Int](0))

  def mpi_recv_T[T:Manifest](buf: Rep[T], count: Rep[Int], dataType: Rep[MPIDataType],
    src: Rep[Int], tag: Rep[Int], comm: Rep[MPIComm], status: Rep[MPIStatus]) =
    libFunction[Int]("MPI_Recv", Unwrap(buf), Unwrap(count), Unwrap(dataType), Unwrap(src), Unwrap(tag),
      Unwrap(comm), Unwrap(status))(Seq(1), Seq(0), Set[Int](0, 6))

  def mpi_scatter[T:Manifest](sendbuf: Rep[Array[T]], count: Rep[Int], sendType: Rep[MPIDataType],
    recvbuf: Rep[Array[T]], recvType: Rep[MPIDataType], root: Rep[Int], comm: Rep[MPIComm]) =
    libFunction[Int]("MPI_Scatter", Unwrap(sendbuf), Unwrap(count), Unwrap(sendType), Unwrap(recvbuf),
      Unwrap(recvType), Unwrap(root), Unwrap(comm))(Seq(0), Seq(3), Set[Int]())

  def mpi_scatterv[T:Manifest](sendbuf: Rep[Array[T]], sendcount: Rep[Array[Int]], disp: Rep[Array[Int]], sendType: Rep[MPIDataType],
    recvbuf: Rep[Array[T]], recvCount: Rep[Int], recvType: Rep[MPIDataType], root: Rep[Int], comm: Rep[MPIComm]) =
    libFunction[Int]("MPI_Scatter", Unwrap(sendbuf), Unwrap(sendcount), Unwrap(disp), Unwrap(sendType),
      Unwrap(recvbuf), Unwrap(recvCount), Unwrap(recvType), Unwrap(comm))(Seq(0, 1, 2), Seq(4), Set[Int]())
